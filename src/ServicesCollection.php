...
class ServicesCollection implements \IteratorAggregate, \ArrayAccess, \Countable
{
     ...
     */
    public function __construct(Container $container, array $servicesIds)
    {
    ...
    {
        throw new \LogicException('Used an invalid method');
    }
    ...
    {
        return false !== array_search($id, $this->servicesIds);
    }
